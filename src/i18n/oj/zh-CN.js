export const m = {
  ...
  How_to_report_bugs: '这OJ有bug阿喂?',
  How_to_report_bugs_answer_part_1: '那当然是联系',
  How_to_report_bugs_answer_part_2: '提交问题。说清楚不足之处。ps:python在部分题目会有编译错误,因为那些题目是当初寒假给初中的c++学员做的,样例没有针对python优化。',
  // Cancel.vue
  Cancel: '取消',
  // ContestDetail.vue
  Problems: '题目',
  ...
  Ended: '已经结束啦',
  No_contest: '尚无练习或比赛',
  Please_login_first: '爬，先去登录！',
  // ContestProblemList.vue
  Problems_List: '想必这些题一定是随便拿捏吧',
  No_Problems: '尚无问题',
  // CodeMirror.vue
  Language: '语言',
  Theme: '主题',
  ...
  Upload_file: '上传文件',
  Monokai: '让你看起来很厉害的黑底',
  Solarized_Light: '低调大气有内涵的白底',
  Material: '卡在黑白之间尴尬的蓝底（但是我最喜欢这个！）',
  // KatexEditor.vue
  ...
  AC_Rate: '通过率',
  // Register.vue
  RegisterUsername: '你的鼎鼎大名',
  Email_Address: '电子邮箱',
  RegisterPassword: '密码',
  Password_Again: '确认密码',
  Captcha: '专门膈应你的验证码',
  UserRegister: '注册',
  Already_Registed: '已经注册了欸？！现在登录吧!',
  The_username_already_exists: '该用户名已存在...',
  The_email_already_exists: '唔，该电子邮件地址已存在',
  password_does_not_match: '密码错了耶',
  Thanks_for_registering: '快去消耗掉自己的头发吧',
  // ResetPassword.vue and ApplyResetPassword.vue
  Reset_Password: '重置这功能我没开阿',
  RPassword: '密码',
  RPassword_Again: '确认密码',
  RCaptcha: '专门膈应你的验证码',
  ApplyEmail: '电子邮箱',
  Send_Password_Reset_Email: '所以你还是自己联系我/少真吧',
  ...
  Rejudge: '重新评分',
  // UserHome.vue
  UserHomeSolved: '成功让他掉头发的问题数量',
  UserHomeserSubmissions: '提交次数',
  UserHomeScore: '分数',
  List_Solved_Problems: '有多少问题消耗了他的头发',
  UserHomeIntro: '他可能是个菜狗耶，一题都没做'
}
